               ...
               <div>
                  ...
                  <select name="jm_code" class="jm_seclect_box">
	               ...
	               <span>전화나 문자로 전화번호를 확인하겠습니다. 일반 문자 메시지 요금 및 데이터 요금이 부과됩니다.</span>
	         	   <input type="hidden" name="url" value="notification.jsp"/>
            ...
            <div id="notice_block">
               ...
               %>
	               ...
	               <div class="notice_txt">
	                  <div>
	                     <div>
	                        <a href="profile_timeline.jsp?thisUserIdx=<%=userIdx%>"><img src="<%=userVo.getUser_image()%>"/></a>
	                     </div><!--notice_img-->
	                     <div><%=txt %></div><!--notice_txt_inner-->
	                     <div><%=year%>년 <%=month%>월</div><!--notice_date-->
	                     <div class="fr">
	                        <button class="delete_button" value="<%=vo.getNotification_idx() %>">
